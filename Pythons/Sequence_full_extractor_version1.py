...
class Sequence_extractor(gr.top_block):
    ...
    def __init__(self, center_chann, chann_num_l, chann_num_r):
        ...
        self.analog_pwr_squelch_xx_0_15 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_14 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_13 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_12 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_11 = analog.pwr_squelch_cc(-15, 1, 25, False)
        ...
        self.analog_pwr_squelch_xx_0_3 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_2 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_1 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0_0 = analog.pwr_squelch_cc(-15, 1, 25, False)
        self.analog_pwr_squelch_xx_0 = analog.pwr_squelch_cc(-15, 1, 25, False)
...
if __name__ == '__main__':
    ...
    for x in range(500):
        chann = []
        chann.append(tb.get_variable_function_probe_0())
        chann.append(tb.get_variable_function_probe_0_0())
        chann.append(tb.get_variable_function_probe_0_1())
        chann.append(tb.get_variable_function_probe_0_2())
        chann.append(tb.get_variable_function_probe_0_3())
        chann.append(tb.get_variable_function_probe_0_4())
        chann.append(tb.get_variable_function_probe_0_5())
        chann.append(tb.get_variable_function_probe_0_6())
        chann.append(tb.get_variable_function_probe_0_7())
        chann.append(tb.get_variable_function_probe_0_8())
        chann.append(tb.get_variable_function_probe_0_9())
        chann.append(tb.get_variable_function_probe_0_10())
        chann.append(tb.get_variable_function_probe_0_11())
        chann.append(tb.get_variable_function_probe_0_12())
        chann.append(tb.get_variable_function_probe_0_13())
        chann.append(tb.get_variable_function_probe_0_14())
        chann.append(tb.get_variable_function_probe_0_15())

        print_elapsed(chann, inception)
        time.sleep(0.005)
