...
def catch_seq(tb):
    ...
    while 1:
        ...
        print_elapsed(['Initial center freq', tb.uhd_usrp_source_0.get_center_freq()], inception)
        print ''
        ...
        tb.set_usrp_freq()
        print_elapsed(['curr chann', tb.FH_seq[tb.curr_chann_idx]], inception)
        print_elapsed(['center freq is changed to', tb.uhd_usrp_source_0.get_center_freq()], inception)
        print ''
...
if __name__ == '__main__':
    ...
    print_elapsed(['Initial center freq: chann', tb.uhd_usrp_source_0.get_center_freq()], inception)
