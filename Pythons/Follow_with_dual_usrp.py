...
class Follow_with_dual_usrp(gr.top_block):
    ...
    def __init__(self, FH_seq):
        ...
        # Blocks
        ##################################################
        self.analog_pwr_squelch_xx_0 = analog.pwr_squelch_cc(-35, 1, 25, False)
        self.uhd_usrp_source_0 = uhd.usrp_source(
        	device_addr="addr0=192.168.10.2, addr1=192.168.20.2",
        ...
        self.connect((self.fir_filter_xxx_0, 0), (self.blks2_selector_0, 0))
...
def catch_seq(tb):
    ...
    while 1:
        ...
        while tb.get_sql_on():
            time.sleep(0.0005)
            print_elapsed(['tb.get_sql_on()', tb.get_sql_on()], inception)
